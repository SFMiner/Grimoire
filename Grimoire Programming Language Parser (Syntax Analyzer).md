...
# Import the lexer components (assuming they're in the same package)
from grimoire_lexer import Token, TokenType, GrimoireLexer
...
class GrimoireParser:
    ...
    def command_statement(self) -> CommandStatement:
        ...
        self.consume(TokenType.TO, "Expected 'to' after command")
        command = self.consume(TokenType.IDENTIFIER, "Expected command name").lexeme
